# @kolibryjs/vue-plugin [![npm](https://img.shields.io/npm/v/@kolibryjs/vue-plugin.svg)](https://npmjs.com/package/@kolibryjs/vue-plugin)

> Note: as of `vue` 3.2.13+ and `@kolibryjs/vue-plugin` 1.9.0+, `@vue/compiler-sfc` is no longer required as a peer dependency.
...
For JSX / TSX support, [`@kolibryjs/vue-jsx-plugin`](https://github.com/kolibryjs/kolibry-vue-plugin/tree/main/packages/vue-jsx-plugin) is also needed.
...
When `@kolibryjs/vue-plugin` compiles the `<template>` blocks in SFCs, it also converts any encountered asset URLs into ESM imports.
...
> Requires `vue@^3.2.0` & `@kolibryjs/vue-plugin@^0.0.2`
