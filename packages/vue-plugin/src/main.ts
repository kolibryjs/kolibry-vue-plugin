...
import { normalizePath, transformWithEsbuild } from 'kolibry'
import {
  createDescriptor,
  getPrevDescriptor,
  setSrcDescriptor,
...
export async function transformMain(
  ...
  if (ssr) {
    ...
    output.push(
      `import { useSSRContext as __kolibry_useSSRContext } from 'vue'`,
      `const _sfc_setup = _sfc_main.setup`,
      `_sfc_main.setup = (props, ctx) => {`,
      `  const ssrContext = __kolibry_useSSRContext()`,
...
async function genTemplateCode(
  ...
  // compile and inline it directly in the main module. When served in kolibry this
...
function genCSSModulesCode(
  ...
  // inject `.module` before extension so kolibry handles it as css module
