...
import { createFilter, normalizePath } from 'kolibry'
import type { ComponentOptions } from 'vue'
import type { Plugin } from 'kolibry'
...
function parseComponentDecls(node: types.VariableDeclaration, _source: string) {
   const names = []
