...
// preserve this to test loading __filename & __dirname in ESM as Kolibry polyfills them.
// if Kolibry incorrectly load this file, node.js would error out.
globalThis.__kolibry_test_filename = __filename
globalThis.__kolibry_test_dirname = __dirname
...
export default defineConfig(({ command, ssrBuild }) => ({
   ...
   ssr: {
      ...
      // this package has uncompiled .vue files
         '@kolibryjs/example-external-component-test',
      ],
   },
   optimizeDeps: {
      exclude: ['@kolibryjs/example-external-component-test'],
   },
}))
